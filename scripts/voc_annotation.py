    ...
    with open(anno_path, 'a') as f:
        for image_ind in image_inds:
            ...
            for obj in objects:
                ...
                annotation += ' ' + ','.join([int(float(xmin)), int(float(ymin)), int(float(xmax)), int(float(ymax)), str(class_ind)])
            print(annotation)
            f.write(annotation + "\n")
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default=r"C:\Users\gary\Desktop\b09")
    parser.add_argument("--train_annotation", default="../data/dataset/b09_train.txt")
    parser.add_argument("--test_annotation",  default="../data/dataset/b09_test.txt")
